...
This task force will carry on the discussion started in the xref:2025/2025-07-28.adoc[] meeting, which might be summarized as: How do we describe delegation and tool/agent identity in archival-quality terms?
