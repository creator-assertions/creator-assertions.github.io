...
🎥 _1'18":_ Discussed meeting schedule going forward. I no longer have the schedule constraint that prevents an 8am meeting, so I'm now available to start meetings on the hour instead of at 8:30am Pacific.
