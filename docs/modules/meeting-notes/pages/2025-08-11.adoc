...
=== Review open PR for endorsement -> forward permission assertion

Review link:https://github.com/decentralized-identity/cawg-endorsement-assertion/pull/11/files[PR #11: Transition from endorsement to forward-permission].
